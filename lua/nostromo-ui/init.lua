local colors = require("nostromo-ui.colors")
local config = require("nostromo-ui.config")
local utils = require("nostromo-ui.utils")
local bufferline = require("nostromo-ui.integrations.bufferline")
local cmp = require("nostromo-ui.integrations.cmp")
local theme = {}
...
function theme.colorscheme()
	if vim.version().minor < 8 then
		vim.notify("Neovim 0.8+ is required for nostromo-ui colorscheme", vim.log.levels.ERROR, { title = "Min Theme" })
		return
	end
